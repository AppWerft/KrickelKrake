view.facebook = ( function() {
		var api = {};
		api.getUploaderWindow = function() {
			var win = Ti.UI.createWindow({barColor:'black',title:'FB-Upload'});
			Titanium.Facebook.appid = "296344640447097";
			Titanium.Facebook.permissions = ['publish_stream', 'read_stream'];
//https://developers.facebook.com/apps/296344640447097/summary?web_hosting=0
