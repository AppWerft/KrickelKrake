...
//Rare exceptions to indicate a bug in the _krickelkrake code (Eg, function that a subclass should have implemented)
...
/**
 The base class for KrickelKrake proxies.
 */
