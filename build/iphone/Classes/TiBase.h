...
// in simulator we redefine to format for KrickelKrake Developer console
...
{\
	NSString * exceptionName = [@"org.krickelkrake." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.krickelkrake";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIKrickelKrakeNativeItemNone = -1, 
	UIKrickelKrakeNativeItemSpinner = -2,
	UIKrickelKrakeNativeItemProgressBar = -3,
	
	UIKrickelKrakeNativeItemSlider = -4,
	UIKrickelKrakeNativeItemSwitch = -5,
	UIKrickelKrakeNativeItemMultiButton = -6,
	UIKrickelKrakeNativeItemSegmented = -7,
	
	UIKrickelKrakeNativeItemTextView = -8,
	UIKrickelKrakeNativeItemTextField = -9,
	UIKrickelKrakeNativeItemSearchBar = -10,
	
	UIKrickelKrakeNativeItemPicker = -11,
	UIKrickelKrakeNativeItemDatePicker = -12,
	
	UIKrickelKrakeNativeItemInfoLight = -13,
	UIKrickelKrakeNativeItemInfoDark = -14,
	
	UIKrickelKrakeNativeItemDisclosure = -15,
	
	UIKrickelKrakeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all KrickelKrake instances of
