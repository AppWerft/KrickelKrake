...
/**
 Base class for all KrickelKrake views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the KrickelKrake view hierarchy (such as wrapped iOS UIViews) was touched.
