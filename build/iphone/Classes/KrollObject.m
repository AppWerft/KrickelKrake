 ...
 * Copyright (c) 2009-2011 by KrickelKrake, Inc. All Rights Reserved.
...
//@interface KrickelKrakeObject : NSObject
//@end

@interface KrickelKrakeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[KrickelKrakeObject class]])
		{
			for (NSString *key in [[(KrickelKrakeObject*)o modules] allKeys])
			{
