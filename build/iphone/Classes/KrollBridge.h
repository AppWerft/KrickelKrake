...
@interface KrickelKrakeObject : KrollCoverageObject {
#else
@interface KrickelKrakeObject : KrollObject {
#endif
@private
...
extern NSString * KrickelKrake$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	KrickelKrakeObject *_krickelkrake;
    KrollObject* console;
	BOOL shutdown;
